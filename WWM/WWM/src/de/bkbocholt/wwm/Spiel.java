...
public class Spiel 
{
	...
	public Spiel()
	{
		...
		fragenKatalog[1] = new Frage("Welche Farbe hat der Himmel?", new String[]{"a) Grün", "b) Blau", "c) Rot", "d) Gelb"}, "b");
		...
		fragenKatalog[4] = new Frage("Welche Sprache wird in Brasilien gesprochen?", new String[]{"a) Spanisch", "b) Portugiesisch", "c) Englisch", "d) Französisch"}, "b");
        fragenKatalog[5] = new Frage("Wie viele Planeten hat das Sonnensystem?", new String[]{"a) 7", "b) 8", "c) 9", "d) 10"}, "b");
        fragenKatalog[6] = new Frage("Was ist die größte Wüste der Welt?", new String[]{"a) Sahara", "b) Gobi", "c) Antarktis", "d) Kalahari"}, "c");
        ...
        fragenKatalog[8] = new Frage("Welcher Planet ist der sonnennächste?", new String[]{"a) Venus", "b) Erde", "c) Mars", "d) Merkur"}, "d");
        fragenKatalog[9] = new Frage("Wie viele Ringe sind auf der olympischen Flagge?", new String[]{"a) 4", "b) 5", "c) 6", "d) 7"}, "b");
        fragenKatalog[10] = new Frage("Was ist die Hauptstadt von Deutschland?", new String[]{"a) München", "b) Frankfurt", "c) Berlin", "d) Hamburg"}, "c");
        fragenKatalog[11] = new Frage("Welches Tier ist das größte Landraubtier?", new String[]{"a) Löwe", "b) Tiger", "c) Eisbär", "d) Braunbär"}, "c");
        fragenKatalog[12] = new Frage("Wie viele Minuten hat eine Stunde?", new String[]{"a) 60", "b) 50", "c) 45", "d) 30"}, "a");
        fragenKatalog[13] = new Frage("Welches ist das längste Fließgewässer der Welt?", new String[]{"a) Amazonas", "b) Nil", "c) Yangtse", "d) Mississippi"}, "b");
        ...
        fragenKatalog[19] = new Frage("Wie viele Bundesländer hat Deutschland?", new String[]{"a) 14", "b) 15", "c) 16", "d) 17"}, "c");
        fragenKatalog[20] = new Frage("Was ist das höchste Gebäude der Welt?", new String[]{"a) Shanghai Tower", "b) Abraj Al Bait Towers", "c) One World Trade Center", "d) Burj Khalifa"}, "d");
        fragenKatalog[21] = new Frage("Welcher Planet ist der größte im Sonnensystem?", new String[]{"a) Jupiter", "b) Saturn", "c) Uranus", "d) Neptun"}, "a");
        fragenKatalog[22] = new Frage("Wie viele Zähne hat ein erwachsener Mensch?", new String[]{"a) 28", "b) 30", "c) 32", "d) 34"}, "c");
        fragenKatalog[23] = new Frage("Was ist das chemische Symbol für Gold?", new String[]{"a) Ag", "b) Au", "c) Gd", "d) Ga"}, "b");
        fragenKatalog[24] = new Frage("Welches Land ist flächenmäßig das größte?", new String[]{"a) Kanada", "b) USA", "c) China", "d) Russland"}, "d");
        fragenKatalog[25] = new Frage("Wie viele Herzen hat ein Oktopus?", new String[]{"a) 1", "b) 2", "c) 3", "d) 4"}, "c");
        fragenKatalog[26] = new Frage("Welcher Vogel kann nicht fliegen?", new String[]{"a) Strauß", "b) Adler", "c) Spatz", "d) Taube"}, "a");
        ...
        fragenKatalog[29] = new Frage("Welches Tier ist das größte Säugetier?", new String[]{"a) Elefant", "b) Blauwal", "c) Nashorn", "d) Flusspferd"}, "b");
        ...
        fragenKatalog[35] = new Frage("Welches ist das höchste Gebirge der Welt?", new String[]{"a) Anden", "b) Rocky Mountains", "c) Himalaya", "d) Alpen"}, "c");
        fragenKatalog[36] = new Frage("Wie viele Monate haben 28 Tage?", new String[]{"a) 1", "b) 2", "c) 12", "d) 6"}, "c");
        fragenKatalog[37] = new Frage("Was ist das kleinste Knochen im menschlichen Körper?", new String[]{"a) Steigbügel", "b) Hammer", "c) Amboss", "d) Sesambein"}, "a");
        ...
        fragenKatalog[45] = new Frage("Was ist die Hauptstadt von Ägypten?", new String[]{"a) Kairo", "b) Alexandria", "c) Luxor", "d) Gizeh"}, "a");
        ...
        fragenKatalog[48] = new Frage("Welches Land hat die größte Bevölkerung in Europa?", new String[]{"a) Deutschland", "b) Frankreich", "c) Vereinigtes Königreich", "d) Italien"}, "a");
