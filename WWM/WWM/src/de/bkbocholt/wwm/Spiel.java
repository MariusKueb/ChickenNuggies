...
public class Spiel 
{
	...
	public Spiel()
	{
        ...
        fragenKatalog[6] = new Frage("Was ist die gr��te W�ste der Welt?", new String[]{"a) Sahara", "b) Gobi", "c) Antarktis", "d) Kalahari"}, "c");
        ...
        fragenKatalog[8] = new Frage("Welcher Planet ist der sonnenn�chste?", new String[]{"a) Venus", "b) Erde", "c) Mars", "d) Merkur"}, "d");
        ...
        fragenKatalog[11] = new Frage("Welches Tier ist das gr��te Landraubtier?", new String[]{"a) L�we", "b) Tiger", "c) Eisb�r", "d) Braunb�r"}, "c");
        fragenKatalog[12] = new Frage("Wie viele Minuten hat eine Stunde?", new String[]{"a) 60", "b) 50", "c) 45", "d) 30"}, "a");
        fragenKatalog[13] = new Frage("Welches ist das l�ngste Flie�gew�sser der Welt?", new String[]{"a) Amazonas", "b) Nil", "c) Yangtse", "d) Mississippi"}, "b");
        ...
        fragenKatalog[19] = new Frage("Wie viele Bundesl�nder hat Deutschland?", new String[]{"a) 14", "b) 15", "c) 16", "d) 17"}, "c");
        fragenKatalog[20] = new Frage("Was ist das h�chste Geb�ude der Welt?", new String[]{"a) Shanghai Tower", "b) Abraj Al Bait Towers", "c) One World Trade Center", "d) Burj Khalifa"}, "d");
        fragenKatalog[21] = new Frage("Welcher Planet ist der gr��te im Sonnensystem?", new String[]{"a) Jupiter", "b) Saturn", "c) Uranus", "d) Neptun"}, "a");
        fragenKatalog[22] = new Frage("Wie viele Z�hne hat ein erwachsener Mensch?", new String[]{"a) 28", "b) 30", "c) 32", "d) 34"}, "c");
        fragenKatalog[23] = new Frage("Was ist das chemische Symbol f�r Gold?", new String[]{"a) Ag", "b) Au", "c) Gd", "d) Ga"}, "b");
        fragenKatalog[24] = new Frage("Welches Land ist fl�chenm��ig das gr��te?", new String[]{"a) Kanada", "b) USA", "c) China", "d) Russland"}, "d");
        ...
        fragenKatalog[29] = new Frage("Welches Tier ist das gr��te S�ugetier?", new String[]{"a) Elefant", "b) Blauwal", "c) Nashorn", "d) Flusspferd"}, "b");
        ...
        fragenKatalog[35] = new Frage("Welches ist das h�chste Gebirge der Welt?", new String[]{"a) Anden", "b) Rocky Mountains", "c) Himalaya", "d) Alpen"}, "c");
        fragenKatalog[36] = new Frage("Wie viele Monate haben 28 Tage?", new String[]{"a) 1", "b) 2", "c) 12", "d) 6"}, "c");
        fragenKatalog[37] = new Frage("Was ist das kleinste Knochen im menschlichen K�rper?", new String[]{"a) Steigb�gel", "b) Hammer", "c) Amboss", "d) Sesambein"}, "a");
        ...
        fragenKatalog[45] = new Frage("Was ist die Hauptstadt von �gypten?", new String[]{"a) Kairo", "b) Alexandria", "c) Luxor", "d) Gizeh"}, "a");
        ...
        fragenKatalog[48] = new Frage("Welches Land hat die gr��te Bev�lkerung in Europa?", new String[]{"a) Deutschland", "b) Frankreich", "c) Vereinigtes K�nigreich", "d) Italien"}, "a");
